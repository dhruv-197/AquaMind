"""Concrete evaluation metrics for the demand model (framework interfaces only)."""
...
def build_demand_evaluation_suite() -> EvaluationSuite:
    return EvaluationSuite([DemandMAE(), DemandRMSE(), DemandMAPE(), DemandR2()])
